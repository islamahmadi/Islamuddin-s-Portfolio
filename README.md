...
# [Project 1: Streaming data from its source to HDFS using Apache Flume](https://github.com/ https://github.com/islamahmadi/hadoop/blob/main/flume.config)
...
![The high level Architecture of Apache Flume !](images/Apache1.jpg)
